...
- **Data Type**: USER_ACCOUNT
  *Description: Identifiers that relate to an identifiable person. For example, an account ID, account number, or account name.*
  - `app/src/main/res/values-es/strings.xml (Pattern: uid)`
- `simple-keyboard/src/main/res/values-nl/strings.xml (Pattern: uid)`
- **Data Type**: PERSONAL_INFO_OTHER
  *Description: Any other personal information such as date of birth, gender identity, veteran status, etc.*
  - `app/src/testForschung/java/de/ithandwerkstuttgart/nibra/forschung/MesswerkzeugTest.kt (Pattern: gender)`
- **Data Type**: APPS_ON_DEVICE
  *Description: Information about the apps installed on a user's device.*
  - `simple-keyboard/src/main/java/rkr/simplekeyboard/inputmethod/latin/utils/ApplicationUtils.java (Pattern: getPackageInfo)`
- **Data Type**: EMAIL
  *Description: A user’s email address.*
  - `simple-keyboard/src/main/java/rkr/simplekeyboard/inputmethod/latin/utils/InputTypeUtils.java (Pattern: mailAddress)`
- **Data Type**: NAME
  *Description: How a user refers to themselves, such as their first or last name, or nickname.*
  - `simple-keyboard/src/main/java/rkr/simplekeyboard/inputmethod/latin/utils/SubtypeLocaleUtils.java (Pattern: display_name)`
...
Save final JSON output to `/home/belkis/Loqui/.scratch/play_policy_insights_800fc5a5-4bdb-43f7-8d55-c095e29a8e95/worker_data_safety_part_4.json`.
