...
- **Data Type**: NAME
  *Description: How a user refers to themselves, such as their first or last name, or nickname.*
  - `simple-keyboard/src/main/res/values/donottranslate.xml (Pattern: display_name)`
...
Save final JSON output to `/home/belkis/Loqui/.scratch/play_policy_insights_800fc5a5-4bdb-43f7-8d55-c095e29a8e95/worker_data_safety_part_5.json`.
