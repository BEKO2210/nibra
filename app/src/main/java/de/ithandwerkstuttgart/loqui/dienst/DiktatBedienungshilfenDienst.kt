...
class DiktatBedienungshilfenDienst : AccessibilityService() {
    ...
    private fun zeigeBlase() {
        ...
        val ansicht = ImageButton(this).apply {
            ...
            background = getDrawable(R.drawable.lq_blase_hintergrund)
    ...
    private fun aufBlaseGetippt() {
        ...
        setzeBlasenbild(R.drawable.lq_ic_stopp, R.string.sw_aufnahme_beenden)
        ...
        erkennungsAuftrag = bereich.launch {
            ...
            // Satz hoert Loqui von selbst wieder zu, bis der Nutzer die Blase
    ...
    private fun melde(text: Int) {
        hauptfaden.post {
            ...
            val band = TextView(this).apply {
                ...
                background = getDrawable(R.drawable.lq_band_hintergrund)
    ...
    private fun beendeErkennung() {
        ...
        geschriebeneLaenge = 0
        hauptfaden.post {
            setzeBlasenbild(R.drawable.lq_ic_mikrofon, R.string.sw_aufnahme_starten)
            aktualisiereBlase()
        }
    }
    ...
    private companion object {
        ...
        const val BLASE_ABLAGE = "loqui_blase"
