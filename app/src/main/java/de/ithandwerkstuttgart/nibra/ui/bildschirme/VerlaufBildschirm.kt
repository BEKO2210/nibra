...
import de.ithandwerkstuttgart.nibra.ui.modell.Gruppenschluessel
        ...
        Column(
            ...
            when {
                gruppen.isEmpty() && suchbegriff.isNotEmpty() -> Leerzustand(
                    zeichnung = R.drawable.nb_ic_suche,
...
private fun Suchfeld(
    ...
    OutlinedTextField(
        ...
        leadingIcon = {
            Symbol(zeichnung = R.drawable.nb_ic_suche, beschreibung = null)
        },
        trailingIcon = {
